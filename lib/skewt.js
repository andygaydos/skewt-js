...
var SkewT = function(options)
{
  ...
  var tticks = [-40,-30,-20,-10,0,10];
	...
	if ( showMicrophysics ) {
		var microphysicsSpecies = [
			{ name: "ice", label: "Cloud ice content", color: "#00FFFF" },
      { name: "water", label: "Cloud water content", color: "#00FF00" },
      { name: "rain", label: "Rain", color: "#006600" },
      { name: "snow", label: "Snow", color: "#0000FF" },
      { name: "graupel", label: "Graupel", color: "#FF0000" }
    ];
	} else {
  ...
  var microphysicsgroup  = container.append("g"); // put microphysics in this group
    ...
    var wdirfocus = skewtgroup.append("g").attr("class", "focus winddir").style("display", "none");
    ...
    var wspdfocus = skewtgroup.append("g").attr("class", "focus windspeed").style("display", "none");
		...
		container.append("rect")
			...
			.attr("width", w)
			.attr("height", h)
			.on("mouseover", function() { tmpcfocus.style("display", null); dwpcfocus.style("display", null); hghtfocus.style("display", null); wdirfocus.style("display", null); wspdfocus.style("display", null);})
			.on("mouseout", function() { tmpcfocus.style("display", "none"); dwpcfocus.style("display", "none"); hghtfocus.style("display", "none"); wdirfocus.style("display", "none"); wspdfocus.style("display", "none");})
        ...
        wdirfocus.attr("transform", "translate(" + (w-115)  + "," + y(d.press) + ")");
